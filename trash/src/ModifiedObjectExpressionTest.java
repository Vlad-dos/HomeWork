 ...
 */
public class ModifiedObjectExpressionTest extends test.ObjectExpressionTest {
    public static final Ops OPS = test.ObjectExpressionTest.OPS
    ...
    protected ModifiedObjectExpressionTest(final boolean hard, final boolean bonus) {
        ...
        simplifications.addAll(Util.list(
                new int[]{9, 14, 1},
                new int[]{16, 16, 1},
                new int[]{55, 55, 56}
        ));
    ...
    public static void main(final String[] args) {
        final int mode = BaseTest.mode(args, ModifiedObjectExpressionTest.class, "easy", "hard", "bonus");
